...
messages <- file(paste0(outputdir,"PANSSscriptOut_FA.txt"), open="wt")
...
#Rscript = "SZ_PANSSReg_AllComps_FA_04122022.R"  # This file
...
# Check that all of the required columns are present in the metr_FA.csv files
